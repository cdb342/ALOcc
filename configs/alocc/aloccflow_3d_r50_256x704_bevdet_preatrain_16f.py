...
# +----------------------+-------+-------+-------+--------+------------+-------+
# |         car          | 0.543 | 0.616 | 0.642 | 0.401  |   0.924    | 0.421 |
# |        truck         | 0.439 | 0.551 | 0.601 | 0.356  |   0.691    | 0.517 |
# |       trailer        | 0.264 | 0.373 | 0.455 | 0.617  |   0.913    | 0.424 |
# |         bus          | 0.536 | 0.658 | 0.716 | 0.888  |   1.173    | 0.917 |
# | construction_vehicle | 0.240 | 0.332 | 0.364 | 0.136  |   0.277    | 0.230 |
# |       bicycle        | 0.218 | 0.242 | 0.250 | 0.275  |   1.652    | 0.525 |
# |      motorcycle      | 0.266 | 0.315 | 0.329 | 0.651  |   2.113    | 0.837 |
# |      pedestrian      | 0.344 | 0.401 | 0.421 | 0.343  |   0.627    | 0.524 |
# |     traffic_cone     | 0.342 | 0.364 | 0.373 |  nan   |    nan     |  nan  |
# |       barrier        | 0.416 | 0.455 | 0.471 |  nan   |    nan     |  nan  |
# |  driveable_surface   | 0.487 | 0.587 | 0.697 |  nan   |    nan     |  nan  |
# |      other_flat      | 0.284 | 0.330 | 0.365 |  nan   |    nan     |  nan  |
# |       sidewalk       | 0.273 | 0.322 | 0.368 |  nan   |    nan     |  nan  |
# |       terrain        | 0.264 | 0.332 | 0.390 |  nan   |    nan     |  nan  |
# |       manmade        | 0.447 | 0.532 | 0.584 |  nan   |    nan     |  nan  |
# |      vegetation      | 0.333 | 0.450 | 0.532 |  nan   |    nan     |  nan  |
# +----------------------+-------+-------+-------+--------+------------+-------+
# |         MEAN         | 0.356 | 0.429 | 0.472 | 0.458  |   1.046    | 0.549 |
# +----------------------+-------+-------+-------+--------+------------+-------+
# 2025-10-14 11:37:24,939 - mmdet - INFO -  --- Occ score:0.43126220801558435
